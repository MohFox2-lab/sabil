...
import { Calendar, Plus, X, Save, Upload } from 'lucide-react';
...
export default function Absences() {
  ...
  const createAbsence = useMutation({
    mutationFn: async (data) => {
      ...
      // Update student attendance score if no excuse
      if (!data.has_excuse) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">أعذار الطلاب والغياب</h1>
